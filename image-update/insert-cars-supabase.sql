-- Insert realistic Moroccan-market rental vehicles into public.cars
-- IMPORTANT: Do NOT use Unsplash/external images (URLs here use your local public/images/cars/*.jpg).
-- Ready to paste in Supabase Dashboard -> SQL Editor -> Run.
...
insert into cars (
  ...
  (1, 1, 'Dacia Logan 2024', 'dacia-logan-2024', '/images/cars/dacia-logan-2023.jpg', 260, 'Manual', 5, 'Diesel', true),
  ...
  (2, 3, 'Renault Clio 2019', 'renault-clio-2019', '/images/cars/renault-clio-2022.jpg', 190, 'Manual', 5, 'Diesel', true),
  ...
  -- Additional realistic models (map to existing local images to avoid broken links)
  (2, 3, 'Kia Picanto 2021', 'kia-picanto-2021', '/images/cars/renault-clio-2022.jpg', 175, 'Manual', 4, 'Petrol', true),
  (2, 3, 'Hyundai i10 2022', 'hyundai-i10-2022', '/images/cars/hyundai-i10-2024.jpg', 185, 'Automatic', 4, 'Petrol', true),
  (3, 2, 'Seat Ibiza 2020', 'seat-ibiza-2020', '/images/cars/vw-polo-2023.jpg', 195, 'Manual', 5, 'Petrol', true),
  (1, 1, 'Fiat Tipo 2019', 'fiat-tipo-2019', '/images/cars/dacia-logan-2023.jpg', 205, 'Manual', 5, 'Diesel', true)
...
-- Validation helper (run after):
-- select count(*) as available_cars from cars where available = true;
