            ...
            <div className="space-y-8">
              ...
              <div className="max-w-md">
                <div className="flex flex-col gap-2 sm:flex-row">
                  ...
                  <Link
                    href="/cars"
                    className="rounded-lg bg-emerald-700 px-6 py-3 text-center text-sm font-semibold text-white transition hover:bg-emerald-800 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 sm:text-left"
                  >
                    Rechercher
                  </Link>
                </div>
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <Link
                  href="/cars"
                  className="rounded-lg bg-emerald-700 px-6 py-4 text-center text-sm font-semibold text-white transition hover:bg-emerald-800 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
                >
                  Voir les voitures disponibles
                </Link>
                <a
                  href="https://wa.me/212600000000?text=Salam, je veux louer une voiture à Oujda"
                  className="rounded-lg border border-slate-300 bg-white px-6 py-4 text-center text-sm font-semibold text-slate-700 transition hover:border-slate-400 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2 flex items-center justify-center gap-2"
                >
              ...
              {/* Stats */}
              <div className="grid grid-cols-3 gap-4 pt-8 sm:gap-6">
                <div className="text-center">
                  <div className="text-xl font-bold text-slate-900 sm:text-2xl">{cars.length}+</div>
                  <div className="text-xs text-slate-600 sm:text-sm">Voitures disponibles</div>
                </div>
                <div className="text-center">
                  <div className="text-xl font-bold text-slate-900 sm:text-2xl">{agencies.length}+</div>
                  <div className="text-xs text-slate-600 sm:text-sm">Agences partenaires</div>
                </div>
                <div className="text-center">
                  <div className="text-xl font-bold text-slate-900 sm:text-2xl">500+</div>
                  <div className="text-xs text-slate-600 sm:text-sm">Clients satisfaits</div>
                </div>
              </div>

              {/* Trust Badges */}
              <div className="flex flex-wrap items-center justify-center gap-3 pt-8 sm:gap-4">
                <div className="flex items-center gap-1 rounded-full bg-white px-3 py-1.5 shadow-sm sm:gap-2 sm:px-4 sm:py-2">
                  <svg className="h-4 w-4 text-emerald-600 sm:h-5 sm:w-5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-xs font-semibold text-slate-700 sm:text-sm">Sécurisé</span>
                </div>
                <div className="flex items-center gap-1 rounded-full bg-white px-3 py-1.5 shadow-sm sm:gap-2 sm:px-4 sm:py-2">
                  <svg className="h-4 w-4 text-emerald-600 sm:h-5 sm:w-5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-xs font-semibold text-slate-700 sm:text-sm">Vérifié</span>
                </div>
                <div className="flex items-center gap-1 rounded-full bg-white px-3 py-1.5 shadow-sm sm:gap-2 sm:px-4 sm:py-2">
                  <svg className="h-4 w-4 text-emerald-600 sm:h-5 sm:w-5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-xs font-semibold text-slate-700 sm:text-sm">24/7 Support</span>
                </div>
              </div>
