    ...
    <article className="group overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:shadow-lg hover:border-emerald-200 dark:border-slate-700 dark:bg-slate-950">
      <div className="relative h-48 w-full overflow-hidden bg-slate-100 dark:bg-slate-900">
        ...
        <div className="absolute top-3 left-3">
          <span className={`inline-flex items-center gap-1 rounded-full px-3 py-1 text-xs font-semibold ${availabilityColor}`}>
            {availabilityLabel}
          </span>
        </div>
        ...
        <div className="absolute top-3 right-3">
          <div className="flex items-center gap-1 rounded-full bg-white/90 px-2 py-1 shadow-sm dark:bg-slate-900">
            <span className="text-xs font-semibold text-slate-900 dark:text-slate-100">{agency.rating}</span>
      ...
      <div className="p-5">
        <div className="mb-3">
          <h3 className="text-lg font-bold text-slate-900 group-hover:text-emerald-700 transition-colors dark:text-slate-100">
            {car.name}
          </h3>
        ...
        <div className="mb-4">
          <p className="text-2xl font-bold text-emerald-700">
            {car.price} <span className="text-sm font-normal text-slate-600 dark:text-slate-400">DH/jour</span>
          </p>
        </div>
