    ...
    <article className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-950">
      ...
      <div className="relative h-48 w-full overflow-hidden bg-slate-100 dark:bg-slate-900">
        ...
        <div className="absolute top-3 left-3">
          <div className="h-6 w-20 animate-pulse rounded-full bg-slate-300 dark:bg-slate-700" />
        </div>
        {/* Rating Badge Skeleton */}
        <div className="absolute top-3 right-3">
          <div className="h-6 w-12 animate-pulse rounded-full bg-slate-300 dark:bg-slate-700" />
        </div>
      </div>
    ...
    <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-950">
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1">
          ...
          <div className="mb-1 h-4 w-24 animate-pulse rounded bg-slate-200 dark:bg-slate-800" />
        </div>
